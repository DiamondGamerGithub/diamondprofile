...
(function () {
    const mobileFixHref = 'mobile-fix.css?v=2';
    const alreadyLoaded = Array.from(document.styleSheets).some((sheet) => sheet.href && sheet.href.includes('mobile-fix.css')) || document.querySelector('link[href*="mobile-fix.css"]');
    if (!alreadyLoaded) {
        const link = document.createElement('link');
        link.rel = 'stylesheet';
        link.href = mobileFixHref;
